...
extern devcall pmdinit(struct dentry *);
extern  devcall pmdopen(struct dentry *, char *, char *);
extern devcall ppdinit(struct dentry *);
extern devcall ppdclose(struct dentry *);
extern devcall ppdgetc(struct dentry *);
extern devcall ppdputc(struct dentry *, char );
extern devcall ppdread(struct dentry *, char *, int32 );
extern devcall ppdwrite(struct dentry *, char *, int32 );
